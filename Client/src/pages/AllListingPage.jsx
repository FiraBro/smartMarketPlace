          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            <div className="flex items-center gap-4 w-full lg:w-auto">
              ...
              <div className="relative flex-1 lg:w-96">
                ...
                <motion.input
                  whileFocus={{
                    boxShadow: "0 0 0 3px rgba(249, 160, 63, 0.1)",
                  }}
                  type="text"
            ...
            <div className="flex items-center gap-4 w-full lg:w-auto justify-between">
              <div className="relative">
                <motion.button
                  ...
                  className="flex items-center justify-between w-56 px-5 py-3 rounded-xl border border-gray-200 bg-white/80 backdrop-blur-sm text-gray-700 font-medium hover:border-[#f9A03f] transition-all"
                >
                  {SORT_OPTIONS.find((opt) => opt.value === sortBy)?.label}
                  <FaChevronRight
                    className={`ml-2 transition-transform duration-300 text-[#f9A03f] ${
                ...
                <AnimatePresence>
                  {showSortDropdown && (
                    <motion.ul
                      ...
                      className="absolute z-50 mt-2 w-56 bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden"
                    >
                      {SORT_OPTIONS.map((option) => (
                        <li
                          ...
                          className={`px-5 py-3 cursor-pointer text-sm font-medium transition-all ${
                            sortBy === option.value
